...
const CUBE_VERTICES_DATA: &[Vertex] = &[
    ...
    // Order: BL, TL, TR, BR
    Vertex { position: [-0.5, -0.5, -0.5], color: [1.0, 0.0, 0.0], uv: [0.0, 0.0] }, // 0 (orig V0)
    Vertex { position: [-0.5,  0.5, -0.5], color: [1.0, 0.0, 0.0], uv: [0.0, 0.0] }, // 1 (orig V3)
    Vertex { position: [ 0.5,  0.5, -0.5], color: [1.0, 0.0, 0.0], uv: [0.0, 0.0] }, // 2 (orig V2)
    Vertex { position: [ 0.5, -0.5, -0.5], color: [1.0, 0.0, 0.0], uv: [0.0, 0.0] }, // 3 (orig V1)
    ...
    Vertex { position: [-0.5, -0.5,  0.5], color: [0.0, 1.0, 0.0], uv: [0.0, 0.0] }, // 4 (orig V4)
    Vertex { position: [ 0.5, -0.5,  0.5], color: [0.0, 1.0, 0.0], uv: [0.0, 0.0] }, // 5 (orig V5)
    Vertex { position: [ 0.5,  0.5,  0.5], color: [0.0, 1.0, 0.0], uv: [0.0, 0.0] }, // 6 (orig V6)
    Vertex { position: [-0.5,  0.5,  0.5], color: [0.0, 1.0, 0.0], uv: [0.0, 0.0] }, // 7 (orig V7) - This order is correct
    ...
    Vertex { position: [ 0.5, -0.5, -0.5], color: [0.0, 0.0, 1.0], uv: [0.0, 0.0] }, // 8 (orig V8)
    Vertex { position: [ 0.5,  0.5, -0.5], color: [0.0, 0.0, 1.0], uv: [0.0, 0.0] }, // 9 (orig V11)
    Vertex { position: [ 0.5,  0.5,  0.5], color: [0.0, 0.0, 1.0], uv: [0.0, 0.0] }, // 10 (orig V10)
    Vertex { position: [ 0.5, -0.5,  0.5], color: [0.0, 0.0, 1.0], uv: [0.0, 0.0] }, // 11 (orig V9)
    ...
    Vertex { position: [-0.5, -0.5,  0.5], color: [1.0, 1.0, 0.0], uv: [0.0, 0.0] }, // 12 (orig V12)
    Vertex { position: [-0.5,  0.5,  0.5], color: [1.0, 1.0, 0.0], uv: [0.0, 0.0] }, // 13 (orig V15)
    Vertex { position: [-0.5,  0.5, -0.5], color: [1.0, 1.0, 0.0], uv: [0.0, 0.0] }, // 14 (orig V14)
    Vertex { position: [-0.5, -0.5, -0.5], color: [1.0, 1.0, 0.0], uv: [0.0, 0.0] }, // 15 (orig V13)
    ...
    Vertex { position: [-0.5,  0.5,  0.5], color: [1.0, 0.0, 1.0], uv: [0.0, 0.0] }, // 16 (Original V19)
    Vertex { position: [ 0.5,  0.5,  0.5], color: [1.0, 0.0, 1.0], uv: [0.0, 0.0] }, // 17 (Original V18)
    Vertex { position: [ 0.5,  0.5, -0.5], color: [1.0, 0.0, 1.0], uv: [0.0, 0.0] }, // 18 (Original V17)
    Vertex { position: [-0.5,  0.5, -0.5], color: [1.0, 0.0, 1.0], uv: [0.0, 0.0] }, // 19 (Original V16)
    ...
    Vertex { position: [-0.5, -0.5,  0.5], color: [0.0, 1.0, 1.0], uv: [0.0, 0.0] }, // 20 (Original V20)
    Vertex { position: [-0.5, -0.5, -0.5], color: [0.0, 1.0, 1.0], uv: [0.0, 0.0] }, // 21 (Original V23)
    Vertex { position: [ 0.5, -0.5, -0.5], color: [0.0, 1.0, 1.0], uv: [0.0, 0.0] }, // 22 (Original V22)
    Vertex { position: [ 0.5, -0.5,  0.5], color: [0.0, 1.0, 1.0], uv: [0.0, 0.0] }, // 23 (Original V21)
];
